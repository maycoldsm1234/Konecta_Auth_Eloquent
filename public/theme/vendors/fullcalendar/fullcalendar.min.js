        ...
        var l = n(2),
            ...
            c = function(t) {
                ...
                return l.__extends(e, t), e.prototype.renderFgSegs = function(t) { this.renderFgSegsIntoContainers(t, this.timeGrid.fgContainerEls) }, e.prototype.renderFgSegsIntoContainers = function(t, e) {
                    ...
                    return '<a class="' + f.join(" ") + '"' + (d.url ? ' href="' + u.htmlEscape(d.url) + '"' : "") + (g ? ' style="' + g + '"' : "") + 'title="<b style=' + "'width: 80px; text-align:right; float:left'" + '>HORA : </b><b>&nbsp;&nbsp;' + d.miscProps.hora + '</b><br><b style=' + "'width: 80px; text-align:right; float:left'" + '>DOCUMENTO : </b><b>&nbsp;&nbsp;' + d.miscProps.pac_documento + '</b><br><b style=' + "'width: 80px; text-align:right; float:left'" + '>NOMBRE : </b><b>&nbsp;&nbsp;' + d.miscProps.nom_pac + '</b><br><b style=' + "'width: 80px; text-align:right; float:left'" + '>SERVICIO : </b><b>&nbsp;&nbsp;' + d.miscProps.procede + '</b><br><b style=' + "'width: 80px; text-align:right; float:left'" + '>ESTADO : </b><b>&nbsp;&nbsp;' + d.miscProps.testado + '</b><br>"><div class="fc-content">' + (n ? '<div class="fc-time" data-start="' + u.htmlEscape(i) + '" data-full="' + u.htmlEscape(r) + '"><span>' + u.htmlEscape(n) + "</span></div>" : "") + (d.title ? '<div class="fc-title">' + u.htmlEscape(d.title) + "</div>" : "") + '</div><div class="fc-bg"/>' + (h ? '<div class="fc-resizer fc-end-resizer" />' : "") + "</a>"
